...
emissaryQuest.splice(38,0,emissaryPool[0][2],emissaryPool[0][3],emissaryPool[0][4],emissaryPool[0][5],emissaryPool[0][0],emissaryPool[0][1],emissaryPool[0][4],
    ...
    emissaryPool[0][1],emissaryPool[0][5],emissaryPool[0][0],emissaryPool[0][4],emissaryPool[0][2],emissaryPool[0][3],emissaryPool[0][0],
    emissaryPool[0][1],emissaryPool[0][5],emissaryPool[0][2]);
...
emissaryReward.splice(38,0,emissaryPool[1][0],emissaryPool[1][1],emissaryPool[1][0],emissaryPool[1][2],emissaryPool[1][3],emissaryPool[1][4],emissaryPool[1][2],
    ...
    emissaryPool[1][3],emissaryPool[1][0],emissaryPool[1][2],emissaryPool[1][2],emissaryPool[1][0],emissaryPool[1][1],emissaryPool[1][2],
    emissaryPool[1][1],emissaryPool[1][3],emissaryPool[1][2]);
...
var warFrontlineDonationNum = checkQuantity(warFrontlineDonation[1][2]);
var warFrontlineDonationGoods = warFrontlineDonation[2][2];
...
// LEG part
var legEmiPool = ["法罗迪斯宫廷","织梦者","高岭诸族","瓦拉加尔","堕夜精灵","肯瑞托","守望者","抗魔联军","圣光军团","阿古斯防卫军"];
...
legEmiQuest.splice(43,0,legEmiPool[0],legEmiPool[6],legEmiPool[4],legEmiPool[3],legEmiPool[1],legEmiPool[0],legEmiPool[5],
    ...
    legEmiPool[4],legEmiPool[3],legEmiPool[9],legEmiPool[5],legEmiPool[1],legEmiPool[2],legEmiPool[4],
    legEmiPool[3],legEmiPool[1],legEmiPool[7],legEmiPool[0],legEmiPool[6]);
...
var legWorldBoss2 = [];
legWorldBoss2[0] = ["燃烧废土","燃烧废土","安托兰废土","克罗库恩","索塔纳索尔loca","燃烧废土"];
...
function mainLoop(){
    ...
    innerHtml("war-Frontline-output",warFrontlineOutput(1, "部落", new Date(2018,10,1,19,10),cur));
